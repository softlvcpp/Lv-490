...
//void XMLClient::WriteSystemInformation(string &xml_str, ClientSysInfo &obj) const noexcept
//{
//    XMLDocument xml_doc;
//    //root
...
//    cpu_numbers->SetText(obj.Get_CPUNumbers());
...
//    cpu_vendor->SetText(obj.Get_CPUVendor().c_str());
...
//    cpu_speed->SetText(obj.Get_CPUSpeed());
